...
#[test]
fn get_version_protocol_send() {
    let mut data = vec![GetVersionData::Protocol.into()];
...
#[test]
fn get_version_asr_send() {
    let mut data = vec![GetVersionData::Asr.into()];
    data.append((1 as u32).to_le_bytes().to_vec().as_mut());
    assert_eq!(data.len(), 5);
    let mut checksum: u16 =
        u8::from(MessageType::CommandDown) as u16 + u8::from(Command::GetVersion) as u16;
...
#[test]
fn get_version_preprocess_send() {
    let mut data = vec![GetVersionData::Preprocess.into()];
    data.append((1 as u32).to_le_bytes().to_vec().as_mut());
    assert_eq!(data.len(), 5);
    let mut checksum: u16 =
        u8::from(MessageType::CommandDown) as u16 + u8::from(Command::GetVersion) as u16;
...
#[test]
fn get_version_player_send() {
    let mut data = vec![GetVersionData::Player.into()];
    data.append((1 as u32).to_le_bytes().to_vec().as_mut());
    assert_eq!(data.len(), 5);
    let mut checksum: u16 =
        u8::from(MessageType::CommandDown) as u16 + u8::from(Command::GetVersion) as u16;
...
#[test]
fn get_version_application_send() {
    let mut data = vec![GetVersionData::Application.into()];
    data.append((1 as u32).to_le_bytes().to_vec().as_mut());
    assert_eq!(data.len(), 5);
    let mut checksum: u16 =
        u8::from(MessageType::CommandDown) as u16 + u8::from(Command::GetVersion) as u16;
